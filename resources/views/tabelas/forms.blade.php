<!DOCTYPE html>
<html :class="{ 'theme-dark': dark }" x-data="data()" lang="pt">
  <head>
    <meta charset="UTF-8" />
            ...
            <form action="{{route('buttons-store')}}"   method="POST">
              ...
              <div class="form-group">
                <div class="form-group">
                  ...
                  <input type="text"  class="form-control" name="ndebi">
                    </div>
                    <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="number"  class="form-control" name="numerotelefone">
                </div>
                <br>
                <div class="form-group">
...
<form action="{{route('modals-store')}}"   method="POST">
  ...
  <div class="form-group">
    <div class="form-group">
      ...
      <input type="text"  class="form-control" name="matricula1">
    </div>
         <div class="form-group">
      ...
      <input type="text"  class="form-control" name="marca1">
    </div>
    <div class="form-group">
      <label for="ndemotor1">Número de Motor</label>
      <input type="text"  class="form-control" name="ndemotor1">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text"  class="form-control" name="medidaspneus">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text"  class="form-control" name="dentreixos">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      <label for="ndequadro1">Número de Motor</label>
      <input type="text"  class="form-control" name="ndequadro1">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text"  class="form-control" name="tipodecaixa">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <input type="text"  class="form-control" name="ndecilindro">
    </div>
    </div>
    <br>
    <div class="form-group">
...
<form action="{{route('tables-store')}}"   method="POST">
  ...
  <div class="form-group">
    <div class="form-group">
      ...
      <input type="text"  class="form-control" name="ndequadro">
    </div>
         <div class="form-group">
      ...
      <input type="text"  class="form-control" name="nometitular">
        ...
        <div class="form-group">
      <label for="ndebi1">Número de B.I</label>
      <input type="text"  class="form-control" name="ndebi1">
    </div>
    <div class="form-group">
      <label for="ndemotor">Número de Motor</label>
      <input type="text"  class="form-control" name="ndemotor">
    </div>
    <div class="form-group">
      <label for="dataemissao">Data de Emissão do Titúlo</label>
