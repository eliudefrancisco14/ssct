                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="detail-box">
                                        ...
                                        <div class="btn-box">
                                            <a href="{{ route('site') }}" class="btn-1"> Cadastrar </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-7">
                                    <div class="detail-box">
                                        ...
                                        <div class="btn-box">
                                            <a href="{{ route('login') }}" class="btn-2"> Entrar </a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-4">
                    <div class="box ">
                        ...
                        <div class="detail-box">
                            ...
                            <p>
                                A UNITEL e os taxistas da Taxion, grupo adstrito a Associação Nova Aliança dos Taxistas
                                de Angola (ANATA) e a Cooperativa de Inovação e Inclusão Social dos Trabalhadores
                                Informais (CIIST), firmaram uma parceria para promover e facilitar o pagamento.
                            </p>
                ...
                <div class="col-md-4">
                    <div class="box ">
                        ...
                        <div class="detail-box">
                            ...
                            <p>
                                Chama-se "Taxi On" e é uma aplicação dedicada a quem recorre a este meio de transporte.
                                Para além de permitir reserva e aluguer de viaturas, a app disponibiliza o selo de
                                credenciamento do taxista, sendo que em caso de acidente de viação.
                            </p>
        ...
        <div class="container">
                ...
                <div class="col-md-4">
                    <div class="box ">
                        ...
                        <div class="detail-box">
                            ...
                            <p>
                                Os dados pessoais do taxista geralmente incluem informações básicas e
                                identificativas.Nome,
                                Endereço Residencial,
                                Número de Identificação,
                                Número de Telefone,
                                Endereço de E-mail,
                                Número de Licença de Condução,
                                Foto.
                            </p>
          ...
          c10.095-0.01,18.276-8.191,18.286-18.286V283.429C475.419,273.334,467.238,265.153,457.143,265.143z" />
                        ...
                        <div class="detail-box">
                            ...
                            <p>
                                O título do veículo, também conhecido como documento de propriedade, é um certificado
                                legal que comprova quem é o proprietário registrado de um veículo. Geralmente, contém
                                informações importantes, como o nome e endereço...
                            </p>
                ...
                <div class="col-md-4">
                 ...
                 C359.352,229.501,347.186,257.357,326.316,275.706z" />
                        ...
                        <div class="detail-box">
                            ...
                            <p>
                                "livrete de viratura"pode ser um termo usado para descrever o documento de registro de
                                um veículo, que contém informações sobre o proprietário, características do veículo,
                                registros de manutenção, entre outros detalhes.
                            </p>
